class IntegerList(list):
    ...
    def __add__(self,iterable):
        for element in iterable:
            IntegerList.check_value_type(element)
        return list.__add__(self,iterable)
...
try:
    int_list.insert(1,67)
except ValueError:
    print('inserting with ineligible element failed')
    
try:
    int_list=int_list+[1,67,99]
except ValueError:
    print('Adding with ineligible element failed')
