...
#
# 1) set the item’s property named accelerator with a string naming the hot-key (note: this has no other effect than just displaying the right-aligned string inside the item
#   – no callback is set at the moment).line 33
# 2) make a global binding linking the hot-key with a proper callback. line 38